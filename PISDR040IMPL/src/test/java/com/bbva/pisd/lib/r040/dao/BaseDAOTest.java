...
public class BaseDAOTest {
    ...
    public void executeQueryNoResultExceptionTest(){
        ...
        try {
            ...
            Assert.assertEquals(DatabaseParticipantErrors.QUERY_EMPTY_RESULT.getAdviceCode(),e.getAdviceCode());
            Mockito.verify(jdbcUtils, Mockito.atLeastOnce())
    ...
    public void executeQuerySelectTimeoutExceptionTest(){
        ...
        try {
            ...
            Assert.assertNull(resultObject);
            Assert.assertEquals(DatabaseParticipantErrors.ERROR_TIME_OUT.getAdviceCode(), e.getAdviceCode());
            Mockito.verify(jdbcUtils, Mockito.atLeastOnce())
                    .queryForMap(Mockito.anyString(),
                            Mockito.anyMap());
        }
    ...
    public void executeQueryDuplicateKeyExceptionTest(){
        ...
        try {
            ...
            Assert.assertEquals(DatabaseParticipantErrors.ERROR_DUPLICATE_KEY.getAdviceCode(), e.getAdviceCode());
            Assert.assertEquals(DatabaseParticipantErrors.ERROR_DUPLICATE_KEY.isRollback(), DatabaseParticipantErrors.ERROR_DUPLICATE_KEY.isRollback());
            Assert.assertEquals(DatabaseParticipantErrors.ERROR_DUPLICATE_KEY.getMessage(), DatabaseParticipantErrors.ERROR_DUPLICATE_KEY.getMessage());
            Mockito.verify(jdbcUtils, Mockito.atLeastOnce())
                    .queryForMap(Mockito.anyString(),
                            Mockito.anyMap());
        }
    ...
    public void executeQueryIncorrectResultSizeExceptionTest(){
        ...
        try {
            ...
            Assert.assertEquals(null, resultObject);
            Assert.assertEquals(DatabaseParticipantErrors.ERROR_INCORRECT_RESULT.getAdviceCode(), e.getAdviceCode());
            Mockito.verify(jdbcUtils, Mockito.atLeastOnce())
                    .queryForMap(Mockito.anyString(),
                            Mockito.anyMap());
        }
